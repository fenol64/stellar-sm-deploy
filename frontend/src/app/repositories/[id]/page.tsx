    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-gray-800/30 backdrop-blur-sm border border-gray-700/50 rounded-lg p-6">
          <h3 className="text-xl font-semibold text-white mb-6">Deployment History</h3>
          ...
          {repository.deployments.length === 0 ? (
            ...
            <div className="space-y-4">
              {repository.deployments.map((deployment) => (
                <div key={deployment.id} className="bg-gray-900/50 rounded-lg p-4 border border-gray-700/50">
                    ...
                    <div className="flex-1">
                      ...
                      {deployment.contractAddress && (
                        <div className="mb-2">
                          ...
                          <code className="block text-sm text-green-400 font-mono bg-gray-800/50 p-2 rounded mt-1">
                            {deployment.contractAddress}
                          </code>
                        </div>
                      )}
                      ...
                      <div className="grid grid-cols-2 gap-4 text-sm">
                        <div>
                          ...
                          <p className="text-white capitalize">{deployment.network}</p>
                        </div>
                        <div>
                          <label className="text-gray-400">Account:</label>
                          <p className="text-white font-mono text-xs">{deployment.stellarKeypair.testnetPublicKey}</p>
                        </div>
                      </div>
                    </div>
