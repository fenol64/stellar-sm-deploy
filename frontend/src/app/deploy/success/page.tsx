  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {/* Deployment Details */}
        {deployment && (
          <div className="bg-gray-800/30 backdrop-blur-sm border border-gray-700/50 rounded-lg p-6 mb-8">
            <h3 className="text-xl font-semibold text-white mb-4">Deployment Details</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-400 mb-1">Project Name</label>
                <p className="text-white">{deployment.name}</p>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-400 mb-1">Network</label>
                <div className="flex items-center gap-2">
                  <div className="w-2 h-2 rounded-full bg-blue-500"></div>
                  <span className="text-white capitalize">{deployment.network}</span>
                </div>
              </div>
              ...
              <div>
                <label className="block text-sm font-medium text-gray-400 mb-1">Deployed At</label>
                <p className="text-white">{new Date(deployment.deployedAt).toLocaleString()}</p>
              </div>
            </div>
          </div>
        )}
        ...
        <div className="bg-gray-800/30 backdrop-blur-sm border border-gray-700/50 rounded-lg p-6 mb-8">
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-white font-medium">Test Your Contract</p>
                <p className="text-gray-400 text-sm">Use Stellar CLI or SDK to interact with your deployed contract on testnet.</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">Check your contract's performance and usage through Stellar explorers.</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-white font-medium">Deploy More Contracts</p>
                <p className="text-gray-400 text-sm">Continue building and deploying more smart contracts to expand your project.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            href="/"
            className="px-6 py-3 bg-purple-600 hover:bg-purple-700 text-white rounded-lg font-medium transition-all duration-200 flex items-center justify-center gap-2"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-12 text-center">
          <h4 className="text-lg font-medium text-white mb-4">Helpful Resources</h4>
