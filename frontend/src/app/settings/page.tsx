            ...
            <div className="grid gap-8">
              ...
              <div className="bg-gray-800/30 backdrop-blur-sm border border-gray-700/50 rounded-lg p-6">
                <h3 className="text-lg font-medium text-white mb-4 flex items-center gap-2">
                  <div className="w-8 h-8 rounded-lg bg-gray-500/20 border border-gray-500/30 flex items-center justify-center">
              ...
              <div className="bg-gray-800/30 backdrop-blur-sm border border-gray-700/50 rounded-lg p-6">
                ...
                <div className="mt-6 pt-4 border-t border-gray-700/30">
                  <button className="bg-blue-500/20 border border-blue-500/30 text-blue-300 hover:bg-blue-500/30 hover:border-blue-500/50 hover:text-blue-200 backdrop-blur-sm transition-all duration-200 font-medium text-sm h-10 px-4 rounded-lg">
                    Save Preferences
                  </button>
                </div>
              </div>
