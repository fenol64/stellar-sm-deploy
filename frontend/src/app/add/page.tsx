        ...
        <div className="text-center py-8 mb-8">
          ...
          <div className="flex items-center justify-center gap-2 mb-8">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-purple-300 font-medium">Choose Repository</span>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-gray-400">Configure & Deploy</span>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 p-6">
              ...
              <div className="space-y-3 text-sm text-gray-400">
                <div>
                  <p className="font-medium text-white mb-1">Repository Requirements:</p>
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 p-6">
              ...
              <div className="space-y-3">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-3 p-3 bg-green-600/20 hover:bg-green-600/30 border border-green-500/30 rounded-lg transition-colors group"
                >
                  <svg className="w-4 h-4 text-green-400" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M12.316 3.051a1 1 0 01.633 1.265l-4 12a1 1 0 11-1.898-.632l4-12a1 1 0 011.265-.633zM5.707 6.293a1 1 0 010 1.414L3.414 10l2.293 2.293a1 1 0 11-1.414 1.414l-3-3a1 1 0 010-1.414l3-3a1 1 0 011.414 0zm8.586 0a1 1 0 011.414 0l3 3a1 1 0 010 1.414l-3 3a1 1 0 11-1.414-1.414L16.586 10l-2.293-2.293a1 1 0 010-1.414z" clipRule="evenodd" />
                  </svg>
                  <span className="text-sm text-green-300">Examples</span>
                </a>
              </div>
            </div>
          </div>
